...
export const fetchCoffeeStores = async (width = 200, height = 150) => {

    const options = {
        method: 'GET',
        headers: {
            Accept: 'application/json',
            Authorization: process.env.FOURSQUARE_AUTHORIZATION_API_KEY
        }
    }
    ...
    const coffeeStoresData = await fetch(getUrlForCoffeeStores("47.86%2C35.14", "coffee", 6), options)
